...
model = torch.load("/home/jake/Projects/mila/cdvae/assets/checkpoints/zinc-plain-pi-epoch=39-step=104759.ckpt")
...
torch.save(model, "/home/jake/Projects/mila/cdvae/assets/checkpoints/zinc-plain-pi/epoch=39-step=104759-generic.ckpt")
